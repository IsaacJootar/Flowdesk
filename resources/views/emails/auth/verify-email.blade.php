...
<head>
  ...
  <title>Confirm your Flowdesk email</title>
</head>
  ...
  <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:640px;margin:0 auto;background:#ffffff;border-radius:16px;overflow:hidden;border:1px solid #dbe4f0;">
    <tr>
      <td style="padding:24px 32px;background:#0f2747;color:#ffffff;">
        ...
        <div style="font-size:14px;opacity:0.9;margin-top:6px;">Confirm your email (optional)</div>
      </td>
    </tr>
    <tr>
      <td style="padding:32px;">
        ...
        <p style="margin:0 0 16px;font-size:15px;line-height:1.7;">
          Thanks for joining Flowdesk. Your account is already created.
        </p>

        <p style="margin:0 0 20px;font-size:15px;line-height:1.7;">
          If you'd like to confirm this email so we can deliver important alerts and password resets,
          click below.
        </p>
        ...
        <p style="margin:0;font-size:13px;line-height:1.7;color:#64748b;">
          If you did not request this or you already have access, you can ignore this message.
        </p>
      </td>
    </tr>
  </table>
