<div class="space-y-5">
    <div class="fd-card p-5">
        <div class="flex items-start justify-between gap-3">
            <div>
                <p class="text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">Support / Ops Guide</p>
                <h2 class="mt-1 text-xl font-semibold text-slate-900">Communications Recovery Desk</h2>
                <p class="mt-2 text-sm text-slate-600">Use this guide when retries, queue backlog, or delivery configuration issues appear across requests, vendors, or assets communication flows.</p>
            </div>
            <a href="{{ route('requests.communications') }}" class="rounded-xl border border-slate-300 bg-white px-3 py-2 text-xs font-semibold text-slate-700 hover:bg-slate-50">Back to Desk</a>
        </div>
    </div>
    ...
    <div class="fd-card p-5">
        ...
        <ol class="mt-3 list-decimal space-y-2 pl-5 text-sm text-slate-700">
            <li>Open the <span class="font-semibold">Recovery Desk</span> tab and set <span class="font-semibold">Display Scope</span> and <span class="font-semibold">Display Age Filter</span>.</li>
            <li>Check the module cards for failed and stuck queued rows by pipeline.</li>
            ...
            <li>Use <span class="font-semibold">Process Queued</span> to process backlog rows older than your age filter.</li>
    ...
    <div class="fd-card p-5">
        ...
        <ul class="mt-3 list-disc space-y-2 pl-5 text-sm text-slate-700">
            ...
            <li>If queue backlog keeps growing, reduce queue load and verify scheduler/worker health for communication commands.</li>
