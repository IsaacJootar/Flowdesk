...
<div
    ...
    <div class="fd-card p-6">
        ...
        <div class="mt-3 grid gap-4 md:grid-cols-3">
            ...
            <div class="rounded-xl border border-slate-200 bg-slate-50 p-3">
                <p class="text-xs uppercase tracking-[0.1em] text-slate-500">Escalation Grace</p>
        ...
        >
            <div class="w-full max-w-2xl overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-xl">
                <div class="flex items-center justify-between border-b border-slate-200 px-5 py-4">
                    ...
                    <button type=”button” class=”rounded-md p-1.5 text-slate-500 hover:bg-slate-100” wire:click=”closeOverrideModal” aria-label=”Close”>
