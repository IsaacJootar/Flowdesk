<div wire:init="loadData" class="space-y-6">
    ...
    @else
        <section class="grid gap-4 sm:grid-cols-2 xl:grid-cols-5">
            ...
            <div class="rounded-2xl border border-rose-200 bg-rose-50 p-5 text-rose-900"><p class="text-xs font-semibold uppercase tracking-[0.14em]">Procurement Exceptions</p><p class="mt-2 text-2xl font-semibold">{{ number_format((int) ($closeDesk['summary']['open_procurement_exceptions'] ?? 0)) }}</p></div>
