                                ...
                                <td class="px-4 py-3 text-right">
                                    <div class="flex justify-end gap-2">
                                        ...
                                        @can('update', $vendor)
                                            ...
                                            >
                                                <span wire:loading.remove wire:target="openEditModal({{ $vendor->id }})" class="inline-flex items-center gap-1.5">
                                                    <svg class="h-3.5 w-3.5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true">
                                    ...
                                    <div class="rounded-lg border border-slate-200 bg-white px-3 py-3">
                                        ...
                                        @if ($this->canManageVendorFinance || $this->canRecordVendorPayments)
                                            <div class="mt-3 flex flex-wrap items-center justify-end gap-2">
                                                @if ($this->canManageVendorFinance)
                                                    <button type="button" wire:click="openEditInvoiceModal({{ $invoice['id'] }})" class="rounded-lg border border-slate-300 px-2.5 py-1 text-xs font-medium text-slate-700 hover:bg-slate-50">
                                                        <span class="inline-flex items-center gap-1.5">
                                                            <svg class="h-3.5 w-3.5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true">
                                                                <path d="M12 20h9"></path>
                                                                <path d="M16.5 3.5a2.1 2.1 0 0 1 3 3L7 19l-4 1 1-4 12.5-12.5z"></path>
