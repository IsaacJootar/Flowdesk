<div class="space-y-5">
    ...
    <div class="grid gap-4 lg:grid-cols-2">
        <section class="fd-card p-5">
            <h3 class="text-sm font-semibold text-slate-900">1. Prepare organization context</h3>
            <ol class="mt-3 list-decimal space-y-2 pl-5 text-sm text-slate-700">
                <li>Open <a href="{{ route('platform.tenants') }}" class="font-medium text-slate-900 underline">Organization Management</a>.</li>
                <li>Select the organization you want to test{{ $latestTenant ? ' (latest: '.$latestTenant->name.')' : '' }}.</li>
                <li>Confirm organization lifecycle is <span class="font-semibold">active</span>.</li>
            </ol>
        </section>
        ...
        <section class="fd-card p-5">
            ...
            @else
                <p class="mt-3 text-sm text-slate-700">Create at least one organization first, then return here to continue the checklist.</p>
            @endif
        </section>
        ...
        <section class="fd-card p-5">
            ...
            <ol class="mt-3 list-decimal space-y-2 pl-5 text-sm text-slate-700">
                <li>Use organization billing actions (manual payment or charge action) to create billing attempts.</li>
        ...
        <section class="fd-card p-5">
            ...
            <ol class="mt-3 list-decimal space-y-2 pl-5 text-sm text-slate-700">
                ...
                <li>Filter by organization/provider/pipeline and inspect statuses.</li>
    ...
    <section class="fd-card p-5">
        ...
        <ul class="mt-3 list-disc space-y-2 pl-5 text-sm text-slate-700">
            ...
            <li>Organization audit events are written for manual operator actions.</li>
        </ul>
    </section>
</div>
