<div wire:init="loadData" class="space-y-5">
    ...
    <div class="grid gap-3 sm:grid-cols-4">
        ...
        <div class="rounded-2xl border border-amber-200 bg-amber-50 p-4">
            <p class="text-xs uppercase tracking-[0.1em] text-amber-700">Unreconciled Lines</p>
            ...
            <table class="min-w-full divide-y divide-slate-200 text-sm">
                <thead class="bg-slate-50 text-xs uppercase tracking-[0.12em] text-slate-500">
                    <tr>
                        ...
                        <th class="px-4 py-3 text-right font-semibold">Unreconciled Count</th>
                        <th class="px-4 py-3 text-right font-semibold">Unreconciled Value</th>
                    </tr>
                </thead>
