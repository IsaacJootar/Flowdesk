<div class="space-y-6">
    ...
    <div class="fd-card p-6">
        <div class="mb-4 flex flex-wrap items-center justify-between gap-3">
            <div>
                <a href="{{ route('organization.admin-desk') }}" class="inline-flex items-center gap-1 text-xs font-semibold uppercase tracking-[0.1em] text-slate-500 hover:text-slate-700"><span aria-hidden="true">&larr;</span><span>Back to Company Administration</span></a>
                <h3 class="mt-2 text-base font-semibold text-slate-900">Team Assignments</h3>
