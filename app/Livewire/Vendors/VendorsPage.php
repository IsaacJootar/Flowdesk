...
class VendorsPage extends Component
{
    ...
    private function formPayload(): array
    {
        return [
            ...
            'bank_code' => $this->nullableString($this->form['bank_code']),
    ...
    protected function rules(): array
    {
        return [
            ...
            'form.bank_code' => ['required', 'string', 'max:40'],
    ...
    protected function messages(): array
    {
        return [
            ...
            'form.bank_code.required' => 'Bank code is required.',
            ...
            'form.bank_code.max' => 'Bank code cannot exceed 40 characters.',
