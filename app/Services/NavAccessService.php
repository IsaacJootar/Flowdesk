...
class NavAccessService
{
    ...
    private function ownerItems(): array
    {
        return [
            ...
            ['route' => 'settings.chart-of-accounts', 'pattern' => ['settings.chart-of-accounts'], 'label' => 'Accounting Setup'],
            ['route' => 'settings.accounting-integrations', 'pattern' => ['settings.accounting-integrations'], 'label' => 'Accounting Integrations'],
    ...
    private function iconForRoute(string $route): string
    {
        return match ($route) {
            ...
            'settings.chart-of-accounts', 'settings.accounting-integrations' => 'wallet',
            'settings.index' => 'cog',
            default => 'dot',
        };
    }
